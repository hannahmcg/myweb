      ...
      <NavMain />
        ...
        <section className="">
          <div className="flex justify-center">
            ...
            <Image src={stickerstext} className="hidden lg:block max-w-screen-xl h-auto" sizes="100vw" width="0" height="0" priority={true} alt="fruit stickers with my info in them"/>
