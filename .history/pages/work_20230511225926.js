...
function Work() {
    return (
      <div>
        ...
        {/*<main className="px-10 md:px-20 pb-20 pt-5 w-screen">*/}
          <main className="px-10 md:px-20 pb-20 pt-5n">
            <div className="text-center pb-10">
                <h1 className="text-4xl pb-5 text-slate-900">design & artwork</h1>
                <p className="text-lg text-slate-400">what can be found: new and redesigns, original artwork, creative explorations</p>
            </div>
              ...
              <section>
                <div className="lg:flex lg:justify-center gap-10 items-center">
                    <Link href="cards/compass" className="lg:w-[400px]">
                    ...
                    <Link href="cards/cssa" className="lg:w-[400px]">
                        <div className="shadow-lg hover:shadow-2xl hover:shadow-light-blue-100 overflow-hidden dark:shadow-blue-500 rounded-xl my-10 active:border-blue-200 active:border-2">
                ...
                <Link href="cards/dispotify" className="lg:w-1/3">
                    <div className="shadow-lg hover:shadow-2xl hover:shadow-light-blue-100 active:border-blue-200 active:border-2 overflow-hidden dark:shadow-blue-500 rounded-xl my-10">
                        <div className="relative h-80 w-full md:h-90">
