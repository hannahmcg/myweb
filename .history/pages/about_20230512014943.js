                ...
                <div className="w-1/2 px-5">
                    <ul className="list-disc leading-8 marker:text-light-blue-600 text-slate-700 font-light pl-5">
                      ...
                      <ul className="list-disc leading-6 marker:text-light-blue-600 text-slate-700 font-light pl-5 text-sm">
                        <li>I studied CogSci because I found studying the brain - in all its facets - more exciting than anything else. The Economics part was more random, I just wanted to know what people were saying when talking about stocks (jokes on me I still don't know)</li>
                      </ul>
                      </li>
