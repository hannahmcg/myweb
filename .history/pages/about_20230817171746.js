        ...
        <div className="pb-20 pt-10">
          <div className="flex justify-center space-x-10 pb-10">
            ...
            <div className="md:w-2/5 text-slate-500 space-y-3 md:space-y-3">
              ...
              <p>I’m <span className="text-light-blue-600">creative and curious</span> - I always want to know more. Sometimes that results in me eating live octopus, or face planting on a black diamond slope, or getting highlights in my hair and crying at the result. Or maybe I became good at a new instrument, pick up skills in 3D modeling, learn an entirely new programming language, or get better at communicating with the people I care about.</p>
            </div>
            </div>
          </div>
