...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      ...
      <NavMain />
        <section className="px-5 md:px-8 lg:px-10 pt-10 md:pt-5">
          ...
          <div className="md:pt-20 min-h-screen bg-feet-bg bg-contain bg-no-repeat bg-center md:bg-right-bottom mt-4">
            ...
            <div className="flex">
              <div className="justify-center md:justify-start bottom-0 absolute mb-5">
                <FaArrowDown className="h-8 w-8 text-slate-900"/>
              </div>
            </div>
          </div>

          <div className="">
              <div className="flex items-center justify-center h-[600px] md:h-screen bg-index-bg-m lg:bg-index-bg bg-contain bg-no-repeat bg-center">
