        ...
        <div className="pb-20 pt-10">
          <div className="flex justify-center space-x-10 pb-10">
            ...
            <div className="md:w-1/2 text-slate-500 space-y-5 md:space-y-8">
              ...
              <p className="px-2">I’m <span className="text-light-blue-600">creative and curious</span> - Sometimes this results in me eating live octopus, face planting on a black diamond slope, going down rabbitholes of typography searching, or heavily regretting getting highlights in my hair. Or I become good at music production, pick up skills in 3D modeling, learn an entirely new programming language, or realize I have an affinity for anime.</p>
            </div>
            </div>
          </div>

          <div className="mt-10 text-left md:text-center mx-5 md:mx-20 text-slate-500 space-y-4">
