                ...
                <div className="m-5 pl-5">
                    <ul className="list-disc leading-8 marker:text-light-blue-700 text-slate-700 font-light pl-5">
                      ...
                      <ul className="list-disc leading-8 marker:text-light-blue-700 text-slate-700 font-light pl-5 text-sm">
                        <li>I studied CogSci because I like the brain. The Economics part was more random, I just wanted to know what people were saying when talking about stocks (jokes on me I still don't know)</li>
                      </ul>
                      </li>
