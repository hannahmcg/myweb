            ...
            <div className="text-center pb-10">
              ...
              <section>
                <div className="flex flex-col lg:flex-row lg:justify-center gap-10 items-center">
                    <Link href="cards/compass" className="w-[250px] md:w-[400px]">
                        <div className="shadow-lg hover:shadow-2xl hover:shadow-light-blue-100 overflow-hidden dark:shadow-blue-500 rounded-xl my-10 active:border-blue-200 active:border-2">
                            <div className="relative w-full h-80 md:h-90">
                                <Image src={compasscard} className="object-contain" fill alt="compass logo"/>
                            </div>
                    ...
                    <Link href="cards/cssa" className="w-[250px] md:w-[400px]">
                        <div className="shadow-lg hover:shadow-2xl hover:shadow-light-blue-100 overflow-hidden dark:shadow-blue-500 rounded-xl my-10 active:border-blue-200 active:border-2">
                            <div className="relative h-60 w-full md:h-90">
                ...
                <div className="flex flex-col lg:flex-row lg:justify-center gap-10 items-center">
                    <Link href="cards/mcgpaint" className="w-[250px] md:w-[400px]">
                    ...
                    <Link href="cards/dispotify" className="w-[250px] md:w-[400px]">
