    ...
    <div className={darkMode ? "dark" : ""}>
      ...
      <main className= "px-10 md:px-20 lg:px-40">
        ...
        <section className="mb-10 md:mb-20">
            <Image src={stickers0} className="h-auto max-w-full object-contain" width={1160} height={870} alt="fruit stickers with my info in them"/>
        </section>
        ...
        <div className="fixed bottom-0">
          ...
          <div className="text-5xl text-center flex justify-center gap-16 py-1 text-slate-300  dark:text-slate-600">
