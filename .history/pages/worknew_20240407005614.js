      ...
      <div>
          ...
          <main className="px-10 md:px-20 lg:px-40 pb-20 pt-20 bg-gray-50">
            ...
            <div className="text-center pb-10">
              ...
              <section>
                <div className="flex">
                    <div className="outline-slate-500 outline rounded-md mx-auto grid grid-cols-3 h-auto w-full hover:bg-light-blue-50 py-6 px-2 mx-4">
                        <div className="">
                            <p className="text-xl px-4 pb-2">COMPASS</p>
                        ...
                        <div className="align-middle">
                            ...
                            <p className="outline-slate-500 outline rounded-md px-2 w-fit h-fit mx-2">full stack development</p>
                            <p className="outline-slate-500 outline rounded-md px-2 w-fit h-fit mx-2">ui/ux design</p>
                            </div>
                            <div className="flex justify-end">
                                <p className="mt-16 text-sm">Next.js, PostgreSQL, Figma, Github projects</p>
                            </div>
