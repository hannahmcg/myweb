          ...
          <main className="px-20 pb-20 pt-10 w-screen">
              ...
              <section>
                ...
                <Link href="cards/mcgpaint" className="lg:w-1/3">
                    <div className="shadow-lg hover:shadow-2xl hover:p-2 hover:shadow-light-blue-100 overflow-hidden dark:shadow-blue-500 rounded-xl my-10 active:border-blue-200 active:border-2">
                        <div className="relative w-full h-80">
