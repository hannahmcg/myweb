    ...
    <div className={darkMode ? "dark" : ""}>
      ...
      <main className= "px-5 md:px-20 lg:px-40">
        ...
        <section className="mb-10">
          <div className="flex jusitfy-center items-center mx-auto">
            <Image src={stickers1} className="hidden lg:block" sizes="100vw" width={1000} height={1000} alt="fruit stickers with my info in them"/>
