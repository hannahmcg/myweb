  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      ...
      <main className= "px-10 md:px-20 lg:px-40">
        ...
        <section className="mb-10 relative h-100vh w-100vh">
            <Image src={stickers0} className="hidden lg:block object-cover" fill alt="fruit stickers with my info in them"/>
