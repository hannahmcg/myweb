...
import stickerscap from '../public/index-stickers-caps.png';
import stickerscapM from '../public/index-stickers-caps-mb.png';
      ...
      <NavMain />
        ...
        <section className="px-5 md:px-8 lg:px-10 pt-20">
          <div className="flex justify-center 3xl:pt-10">
            ...
            <Image src={stickerscap} className="hidden lg:block w-full h-auto" sizes="100vw" width="0" height="0" placeholder="blur" priority={true} alt="fruit stickers with my info in them"/>
            <Image src={stickerscapM} className="lg:hidden w-full h-auto" sizes="100vw" width="0" height="0" priority={true} alt="fruit stickers with my info in them"/>
          </div>
        </section>
