      ...
      <div>
          ...
          <main className="px-10 md:px-20 lg:px-40 pb-20 pt-20 bg-gray-50">
            ...
            <div className="text-center pb-10">
              ...
              <section>
                <div className="flex">
                    <div className="outline-slate-900 outline rounded-md mx-auto grid grid-cols-3 h-auto w-full hover:bg-light-blue-50 py-6 px-6">
                        <div className="">
                        ...
                        <div className="flex justify-end">
                            <Image src={compasscard} priority={true} className="object-contain" width={240} height={200} alt="compass logo"/>
                        </div>
                    </div>
                </div>
