  ...
  return (
    <div>
        ...
        <main className="px-10 md:px-20 lg:px-40 pt-5">
            ...
            <div className="lg:flex lg:items-center lg:justify-center lg:space-x-5">
                <div className="w-1/2 px-5">
                    <ul className="list-disc leading-8 marker:text-light-blue-700 text-slate-700 font-light pl-5">
                      <li><span className="text-light-blue-700 font-semibold">Intro: </span>Hi, I'm Hannah! I'm looking for a job and I have too many hobbies</li>
                      <li><span className="text-light-blue-700 font-semibold">Education: </span>
                      Graduated from UC Berkeley in 2022 with degrees in Cognitive Science and Economics
                      <ul className="list-disc leading-6 marker:text-light-blue-700 text-slate-700 font-light pl-5 text-sm">
                        <li>I studied CogSci because I found studying the brain - in all its facets - the most exciting thing. The Economics part was more random, I just wanted to know what people were saying when talking about stocks (jokes on me I still don't know)</li>
                      </ul>
                      </li>
                      <li><span className="text-light-blue-700 font-semibold">Music: </span></li>
                      <li><span className="text-light-blue-700 font-semibold">Music: </span></li>
                    </ul>
                    <div className="py-5">
