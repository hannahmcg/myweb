        ...
        <main className="px-10 md:px-20 lg:px-40 pt-5">
            ...
            <div className="lg:flex lg:items-center justify-center">
                <div className="px-5">
                    ...
                    <ul>
                      <li><span className="text-light-blue-700">Intro: </span>Hi, I'm Hannah! I'm looking for a job and I have too many hobbies</li>
                      <li><span className="text-light-blue-700">Education: </span>Graduated from UC Berkeley in 2022 with degrees in Cognitive Science and Economics</li>
                    </ul>
                    <div>
