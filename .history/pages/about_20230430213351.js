  ...
  return (
    <div>
        ...
        <nav className="p-10 max-w-screen-xl flex flex-wrap justify-between mx-auto items-center text-slate-900 dark:text-white">
            ...
            <div className="w-ful md:block md:w-auto">
              <ul className="flex items-center">
                ...
                <li><Link href="/" className="ml-5 font-semibold">Gallery</Link></li>
              </ul>
            </div>
        </nav>
        ...
        <main className="p-20 w-screen">
            ...
            <div>
            <a href="/HannahMcGowan_Resume.pdf" target="_blank" className="bg-gradient-to-r from-cyan-800 to-blue-400 text-white px-4 py-2 rounded-md ml-8">Resume</a>
            </div>
            <section>
          <div>
