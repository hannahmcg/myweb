        ...
        <div className="pb-20 pt-10">
          <div className="flex justify-center space-x-10 pb-10">
            ...
            <div className="md:w-1/2 text-slate-500 space-y-3 md:space-y-1">
              ...
              <p>I’m <span className="text-light-blue-600">creative and curious</span> - If there's one I thing I find myself wanting, it's to know more. Sometimes that results in me eating live octopus, or immediately eating sh*t on a black diamond slope, or getting highlights in my hair and crying at the result. Or maybe I became good at a new instrument, picked up skills in 3D modeling, learned an entirely new programming language, or cooked a new dish for the first time. I regret nothing, and I appreciate everything.</p>
            </div>
            </div>
          </div>
