        ...
        <div className="pb-20 pt-10">
          <div className="flex justify-center space-x-10 pb-10">
            ...
            <div className="md:w-1/2 text-slate-500 space-y-5 md:space-y-8">
              <p>Hi, I'm Hannah - a multidisciplinary product designer and developer with focuses in UX in frontend engineering. I double majored in Cognitive Science and Economics at UC Berkeley.</p>
            </div>
            </div>
          </div>
