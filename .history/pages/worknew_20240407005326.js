      ...
      <div>
          ...
          <main className="px-10 md:px-20 lg:px-40 pb-20 pt-20 bg-gray-50">
            ...
            <div className="text-center pb-10">
              ...
              <section>
                <div className="flex">
                    <div className="outline-slate-500 outline rounded-md mx-auto grid grid-cols-3 h-auto w-full hover:bg-light-blue-50 px-2 py-2">
                        <div className="">
                        ...
                        <div className="align-middle">
                            ...
                            <div className="flex justify-end">
                                <p className="mt-20 mb-2 text-sm">Next.js, PostgreSQL, Figma, Github projects</p>
                            </div>
