              ...
              <section>
                <div className="lg:flex lg:justify-center gap-10 items-center">
                    <div className="lg:w-1/3 shadow-lg overflow-hidden dark:shadow-blue-500 rounded-xl my-10">
                        ...
                        <h3 className="text-lg font-medium pt-4 text-slate-900 dark:text-slate-300">COMPASS - C4SF</h3>
                    ...
                    <div className="lg:w-1/3 shadow-lg overflow-hidden dark:shadow-blue-500 rounded-xl my-10">
                        ...
                        <h3 className="text-lg font-medium pt-4 text-slate-900 dark:text-slate-300">CSSA WEB REBUILD</h3>
