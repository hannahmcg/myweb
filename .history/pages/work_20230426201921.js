    ...
    return (
      <div>
          ...
          <main className="p-20 w-screen">
              ...
              <section>
                <div className="lg:flex lg:justify-around gap-10 items-center">
                    <div className="md:w-1/3 text-center shadow-lg overflow-hidden dark:shadow-blue-500 rounded-xl my-10">
