                        ...
                        <div className="shadow-lg hover:shadow-2xl hover:shadow-light-blue-100 overflow-hidden dark:shadow-blue-500 rounded-xl my-10 active:border-blue-200 active:border-2">
                            ...
                            <div className="p-5 mt-4">
                                ...
                                <div className="flex text-sm">
                                    <p className="outline-slate-900 outline-1 outline rounded-md py-1 w-fit h-fit">full stack development</p>
                                    <p className="outline-slate-900 outline-1 outline rounded-md py-1 w-fit h-fit ml-2">ui/ux design</p>
                                </div>
