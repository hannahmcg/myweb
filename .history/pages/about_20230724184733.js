        ...
        <div className="pb-20 pt-10">
          <div className="flex justify-center space-x-10 pb-10">
            ...
            <div className="md:w-1/2 text-slate-500 space-y-3 md:space-y-3">
              <p>I’m <span className="text-light-blue-600">interdisciplinary</span> - I like doing and learning everything. Instead of seeing it as spreading myself thin, I'd say this is my greatest skill - the more I explore, the more connections I can make; the more intuition I have. </p>
