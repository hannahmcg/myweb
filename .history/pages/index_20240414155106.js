    ...
    <div className={darkMode ? "dark" : ""}>
      ...
      <NavMain />
        <section className="px-5 md:px-8 lg:px-10 pt-20 md:pt-5">
          ...
          {/* bg-blue-gray-100 */}
          <div className="md:pt-20 h-[400px] md:min-h-screen bg-feet-bg bg-contain bg-no-repeat bg-center md:bg-right-bottom mt-4">
          ...
          <div className="">
              <div className="flex items-center justify-center h-[500px] md:h-screen bg-index-bg-m lg:bg-index-bg bg-contain bg-no-repeat bg-center">
