...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      ...
      <NavMain />
      <main className= "px-5 md:px-8 lg:px-10">
        ...
        <section className="">
          <div className="flex justify-center">
            ...
            <Image src={stickerstext} className="hidden lg:block w-full h-auto max-h-screen" sizes="100vw" width="0" height="0" priority={true} alt="fruit stickers with my info in them"/>
