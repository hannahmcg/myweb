    ...
    <div>
        ...
        <div className="pb-20 pt-10">
          <div className="flex justify-center space-x-10 pb-10">
            ...
            <div className="md:w-1/2 w-[200px] mx-auto pb-10 md:pb-0">
              <Image className="rounded-lg" src={hannahcar} width={340} height={400} alt="picture of me at a racetrack"/>
            </div>
            <div className="md:w-1/2 text-slate-500 space-y-3 md:space-y-3">
              <p>I’m <span className="text-light-blue-600">interdisciplinary</span> - I like doing and learning everything. Instead of seeing it as spreading myself thin, I'd say this is my greatest skill - the more I explore, the more intuitive and novel connections I find myself making. </p>
              <p>I’m <span className="text-light-blue-600">perceptive</span> - I've studied human behavior in just about as many ways as you can think, especially in social settings (sincerely, a former people pleaser).</p>
              <p>I’m <span className="text-light-blue-600">creative and curious</span> - If there's one I thing I find myself wanting, it's to know more. Sometimes that results in me eating live octopus, or immediately eating sh*t on a black diamond slope, or getting highlights in my hair and crying at the result. Or maybe I became good at a new instrument, pick up skills in 3D modeling, learn an entirely new programming language, or get better at communicating with the people I care about.</p>
            </div>
            </div>
          </div>
