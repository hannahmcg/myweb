  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      ...
      <main className= "px-10 md:px-15 lg:px-20">
        ...
        <section>
          <Link href="/about">
          <Image src={berksticker} className="shadow-lg hover:shadow-2xl hover:shadow-light-blue-100 active:border-blue-200 active:border-2" width={200} height={200} alt="berkeley sticker"/>
          </Link>
        </section>
