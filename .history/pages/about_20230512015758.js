            ...
            <div className="pb-10 lg:flex lg:items-center lg:justify-center lg:space-x-5">
                <div className="w-1/2 px-5">
                    <ul className="list-disc leading-8 marker:text-light-blue-600 text-slate-700 font-light pl-5">
                      ...
                      <li><span className="text-light-blue-700 font-semibold">Music: </span>I really like music. I'm always finding new genres, languages, and vibes to obssess over. I make random stuff on the piano - think film soundtracks. </li>
