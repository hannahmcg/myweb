  ...
  return (
    <div>
        ...
        <main className="px-10 md:px-20 lg:px-40 pt-5">
            ...
            <div className="py-10 mx-autp">
              <iframe className="rounded-xl" src="https://open.spotify.com/embed/playlist/613PD49YymDxtoW5FMMa4a?utm_source=generator" width="80%" height="352" frameBorder="0" allowFullScreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
            </div>
            <section>
              <div>
