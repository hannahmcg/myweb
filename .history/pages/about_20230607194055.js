        ...
        <div className="pb-20 pt-10">
          <div className="flex justify-center space-x-10 pb-10">
            ...
            <div className="md:w-1/2 text-slate-500">
              ...
              <p>I'm <span className="text-light-blue-600">driven</span> - with a set goal in mind, I'll find any way to achieve it (while keeping an open mind for new ideas)</p>
            </div>
            </div>
          </div>
