                ...
                <div className="flex">
                    <div className="outline-slate-900 outline rounded-md mx-auto grid  grid-cols-1 md:grid-cols-3 h-auto w-full hover:bg-light-blue-50 py-6 px-6">
                        ...
                        <div className="">
                            ...
                            <p className="outline-slate-900 outline rounded-md px-3 py-1 w-fit h-fit mx-1 md:mx-2">full stack development</p>
                            <p className="outline-slate-900 outline rounded-md px-3 py-1 w-fit h-fit mx-1 md:mx-2">ui/ux design</p>
                            </div>
