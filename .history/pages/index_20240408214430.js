  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <Head>
        ...
        <meta name="description" content="Hi, I'm Hannah. A designer + developer. This is my digital portfolio :)" />
      ...
      <NavMain />
        <section className="px-5 md:px-8 lg:px-10 pt-20 md:pt-5">
          ...
          {/* bg-blue-gray-100 */}
          <div className="md:pt-20 min-h-screen bg-feet-bg bg-contain bg-no-repeat bg-center md:bg-right-bottom my-4 mt-4 mb-20">
            <h1 className="text-6xl md:text-9xl pl-4 text-slate-900 mix-blend-color-burn">HANNAH MCG</h1>
            <div className="pl-5 md:pl-6 text-slate-900">
