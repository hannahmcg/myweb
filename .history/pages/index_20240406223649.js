              ...
              <div className="flex items-center justify-center h-screen bg-index-bg-m  lg:bg-index-bg bg-contain bg-no-repeat bg-center">
                ...
                <div>
                  <ul className="flex text-sm space-x-2">
                    <li><a href="HannahMcGowanResume.pdf" target="_blank">RESUME</a></li>
                    <li><a href="https://github.com/hannahmcg" target="_blank">GITHUB</a></li>
                    <li><a href="mailto:hannahcmcg@berkeley.edu">EMAIL</a></li>
                  </ul>
                </div>
