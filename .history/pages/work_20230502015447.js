          ...
          <main className="px-20 pb-20 pt-10 w-screen">
              ...
              <section>
                ...
                <Link href="cards/mcgpaint" className="lg:w-1/3">
                    <div className="shadow-lg hover:shadow-2xl hover:shadow-light-blue-200 overflow-hidden dark:shadow-blue-500 rounded-xl my-10">
                        <div className="relative w-full h-80">
                ...
                <Link href="cards/dispotify" className="lg:w-1/3">
                    <div className="shadow-lg hover:shadow-2xl active:border-blue-600 active:border-2 overflow-hidden dark:shadow-blue-500 rounded-xl my-10">
                        <div className="relative h-80 w-full md:h-90">
