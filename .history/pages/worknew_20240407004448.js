                ...
                <div className="flex">
                    <div className="outline-slate-500 outline rounded-md mx-auto grid grid-cols-3 h-40 w-full hover:bg-light-blue-50">
                        <div className="">
                            ...
                            <p>Open-source application built for case managers and paraeducators of the SFUSD. Digitizing their workflow processes, especially in data collection and analysis.</p>
                        </div>
                        <div className="flex">
