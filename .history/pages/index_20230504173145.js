...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      ...
      <main className= "bg-white dark:bg-slate-900 px-5 md:px-20 lg:px-40">
        ...
        <div className=" lg:flex items-center mt-20" >
          <div className="lg:w-3/5 items-center">
            <div className="text-center p-10">
              <h2 className="text-2xl md:text-5xl py-2 text-slate-700 dark:text-slate-300 font-medium md:text-6xl">Hannah McGowan</h2>
              <h3 className="text-2xl py-2 md:text-3xl text-slate-900 dark:text-slate-400">full stack developer and designer.</h3>
              <p className="text-md py-5 leading-8 text-slate-500 dark:text-slate-600 md:text-lg max-w-xl mx-auto">
