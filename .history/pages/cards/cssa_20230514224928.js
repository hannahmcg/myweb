                ...
                <div className="md:flex-grow">
                    ...
                    <div id="5" className="md:pl-10 pt-10 pb-20">
                        ...
                        <ul className="list-disc text-slate-500 font-light pl-3 pt-10">
                            <li>This taught me a lot about organization and building something in which I'm working simultaneously on my own and with teams of people. I couldn't have asked for a better first project to gain experience with designing, building, and planning.</li>
                            <li>something 2</li>
                        </ul>
                    </div>
