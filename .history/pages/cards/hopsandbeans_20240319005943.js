          ...
          <main className="px-5 md:px-20 lg:px-40 pb-20 pt-10">
              <section className="items-center text-center md:min-h-screen pb-10 md:pb-0">
                ...
                <div className="px-2 py-4">
                    <h1 className="font-semibold text-xl md:text-4xl text-slate-900">Hops and Beans Website</h1>
                    <p className="text-slate-400 text-sm md:text-base mt-10">A case study on a florist inventory management app.</p>
                </div>
              </section>
                    ...
                    <div id="1" className="md:pl-10 min-h-screen xl:min-h-0 xl:pb-20">
                        <div className="grid grid-cols-2 gap-4 md:grid-cols-4 text-sm">
                            <div className="text-slate-500 font-light">
                                ...
                                <p className="">Full Stack Designer</p>
                            </div>
                            <div className="text-slate-500 font-light">
                            ...
                            <div className="text-slate-500 font-light">
                                ...
                                <p>Per Google UX Cert</p>
                            </div>
                            <div className="text-slate-500 font-light">
                                <p className="font-semibold text-slate-900">Tools</p>
                                <p>Figma, Google Sheets, Design System</p>
                            </div>
                        </div>
                        <div className="mt-20 text-slate-500 font-light">
                            <p className="font-semibold text-slate-900 pb-1">What is Perennial?</p>
                            <p>something</p>
                            <br></br>
                            <p>something pt 2
                            </p>
