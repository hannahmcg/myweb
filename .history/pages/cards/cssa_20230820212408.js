                    ...
                    <div id="3" className="md:pl-10 pt-10 min-h-screen">
                        ...
                        <div className="my-10 text-slate-500 font-light">
                            ...
                            <div>
                                ...
                                <p className="pb-3">One of the coolest elements I incorporated onto the website was <a href="https://vincentgarreau.com/particles.js/" className="text-blue-500 underline">particles.js</a>.</p>
