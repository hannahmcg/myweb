                ...
                <div className="flex-grow">
                    ...
                    <div id="3" className="pl-10 pt-10 min-h-screen">
                        ...
                        <div className="my-10 text-slate-500 font-light">
                            ...
                            <p>Now getting to the actual design. Here's a mini design system display to portray all of the elements that ended up coming together:</p>
                        </div>
                    </div>
                    <div id="4" className="pl-10 pt-10 min-h-screen">
                        ...
                        <div className="my-10 text-slate-500 font-light">
                            ...
                            <p className="pb-2">The main actual improvement I say I made to the website architecture for the CSSA was transferring the file system from Filezilla to Github.</p>
                            <p className="pb-2">Making a new repo was easy since I was just starting a new website from scratch. It was the deploying and hosting side of things that I barely understood and by far the most important part.</p>
                            <p className="pb-2">Now it would be a bit egregious of me to say I did this myself. I barely listened in class when it came to using Git so I was lost - but I knew some people who would’nt be, and that would be the OCF.</p>
                            <p className="pb-2">The OCF is what the CSSA website uses to host its website for free - yay!. They’re an organization based in UC Berkeley and give free hosting to Berkeley clubs (figures). So I marched my way into their office and asked for help many, many times. Eventually we were able to figure out (together - yay teamwork) how to configure the remote repo with them to connect to the new repo I created on github. The years long process of locally sharing files and configuring them with Filezilla was over, and now the files could be pulled and changed at any time. Success!</p>
                        </div>
                    </div>
                    <div id="5" className="pl-10 pt-10 min-h-screen">
