                ...
                <div className="md:flex-grow">
                    <div id="1" className="md:pl-10 min-h-screen motion-safe:animate-fadeIn">
                        ...
                        <div className="mt-20 text-slate-500 font-light">
                            ...
                            <p className="pb-3">My senior year I got elected as the sole Tech Director, and decided to take on the challenge of <span className="bg-blue-500/10 p-1 rounded-sm">changing the website for the first time since it’s creation over ten years prior.</span>
