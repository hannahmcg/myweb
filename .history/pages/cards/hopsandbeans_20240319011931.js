                ...
                <div className="md:flex-grow">
                    ...
                    <div id="1" className="md:pl-10 min-h-screen xl:min-h-0 xl:pb-20">
                        ...
                        <div className="mt-20 text-slate-500 font-light">
                            ...
                            <br></br>
                            <p>
                                Now that the majority of the website is built, we're just waiting on the finalization of the menu and the photoshoot from the cafe owner to publish the website.
                            </p>
                        </div>
                    </div>
                    <div>
