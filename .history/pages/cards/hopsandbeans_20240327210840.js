              ...
              <section className="md:flex">
                ...
                <div className="md:flex-grow">
                    ...
                    <div id="3" className="md:pl-10 pt-10 min-h-screen pb-20">
                        ...
                        <div className="mt-10">
                                <p className="font-semibold text-slate-900 pb-1">Competitive Analaysis</p>
                        ...
                        <div className="mt-10">
                                ...
                                <p className="text-slate-500 font-light">Used a moodboard to give help nail down desired visual deisgn elements using visual cues - helps to define the general aesthetic, layout, colors, etc.</p>
                                <div className="pt-5 pb-10">
                    ...
                    <div id="4" className="md:pl-10 pt-10 pb-20">
                        ...
                        <div className="mt-10">
                            <p className="font-semibold text-slate-900 pb-1">The Process</p>
                            <p className="text-slate-500 font-light">I would sometimes show screens with two example color palettes (like dark footer vs white footer) to give the option of choice to the owner.</p>
                        </div>
