      ...
      <div className="scroll-smooth">
        ...
        {/*
          ...
          <main className="px-5 md:px-20 lg:px-40 pb-20">
            <nav className="py-10 px-5 max-w-screen-xl flex flex-wrap justify-between mx-auto items-center text-slate-900">
              ...
              <section className="items-center text-center md:min-h-screen">
