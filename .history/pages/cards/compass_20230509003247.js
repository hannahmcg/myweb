          ...
          <main className="px-10 md:px-20 lg:px-40 pb-20 pt-10 w-screen">
              ...
              <section className="flex">
                ...
                <div className="flex-grow scroll-smooth">
                    ...
                    <div id="scrollspy-2">
                    <div id="item-1" className="pl-10 h-screen motion-safe:animate-fadeIn">
                    ...
                    <div id="item-2" className="pl-10 pt-10 min-h-screen">
                        ...
                        <div className="">
                            ...
                            <div className="p-5">
                                <Image src={compassds} className="object-contain mx-auto" width={500} height={500} alt="visual design elements for compass"/>
                            </div>
                    ...
                    <div id="item-3" className="pl-10 pt-10 pb-20">
                    ...
                    <div id="item-4" className="pl-10 pt-10 pb-20">
                        ...
                        <ul className="list-disc text-slate-500 font-light pl-1">
