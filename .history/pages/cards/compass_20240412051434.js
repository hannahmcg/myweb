                    ...
                    <div id="3" className="md:pl-10 pt-10 min-h-screen pb-20">
                        ...
                        <div className="">
                            <div className="mt-10 text-slate-600 font-light">
                                ...
                                <br></br>
                                <p className="text-slate-600 font-light">Our primary question: how can we visualize data in meaningful ways for both the CMs and paras?</p>
                                <br></br>
                                <p className="text-slate-600 font-light">We had to understand how they currently analyze data and present it in ways that demonstrate a student’s progress. 
                                </p>
                                <br></br>
                                <p className="text-slate-600 font-light">Current objectives: best ways to visualize outlier data; should data be displayed at varying hierarchical levels in the IEP; how should graph types be determined
                                </p>
