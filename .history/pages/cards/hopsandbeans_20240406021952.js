                ...
                <div className="md:flex-grow">
                    ...
                    <div id="1" className="md:pl-10 xl:min-h-0 xl:pb-20">
                        ...
                        <div className="mt-20 text-slate-500 font-light">
                            ...
                            <p>Hops & Beans is a <span className="text-light-blue-600 font-normal">locally-owned cafe</span> within a historical building that serves craft coffee, beer, and a great selection of foods. 
                                When <span className="text-light-blue-600 font-normal">I worked there as a barista,</span> the cafe lacked a fully functioning and designed website – so I offered up my skills. 
                    ...
                    <div id="2" className="md:pl-10 pt-10 pb-20">
                        ...
                        <div className="mt-10">
                            ...
                            <p className="text-slate-500 font-light">
                                Focus on <span className="font-normal text-light-blue-800">ease of use and simplicity</span> while maintaining a <span className="font-normal text-light-blue-800">timeless brand aesthetic</span>.
                            </p>
                        </div>
                        <div className="mt-10">
