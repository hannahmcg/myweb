                ...
                <div className="flex-grow">
                    ...
                    <div className="pl-10 h-screen motion-safe:animate-fadeIn">
                        ...
                        <div className="mt-20">
                            ...
                            <p>McGowan Painting is the name of the small business founded by Kevin McGowan, a painting contractor (who also happens to be my father). He’s never had a online presence, which brought him to commission me for a website. He wanted two things: for his name to come up when someone looked him up on google, and to have something represent his business online.</p>
                            <p>This was my first commission for a client (and for $$). I had to consider some new factors, especially with SEO. I had to know how to prepare my questions and accurately gauge the client’s needs and interests, as well as present a very organized structure with continuous feedback worked into the schedule.</p>
                        </div>
                        <div className="mt-20">
