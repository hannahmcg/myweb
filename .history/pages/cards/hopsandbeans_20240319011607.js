                    ...
                    <div id="1" className="md:pl-10 min-h-screen xl:min-h-0 xl:pb-20">
                        ...
                        <div className="mt-20 text-slate-500 font-light">
                            ...
                            <p>Hops & Beans Cafe is a locally-owned cafe in Fremont, CA. It's located at the oldest commercial building in the city, and serves a great selection of craft coffee, beers, and bites. 
                                As a former barista working there, I reached out to the owner about drafting up a new website for the cafe. </p>
                            <br></br>
                            <p>
                            </p>
                        </div>
                        ...
                        <div className="mt-20 text-slate-500 font-light">
                            ...
                            <p>From there, the design and development process was very iterative. I would draft up a couple ideas and examples in figma, we would discuss them in the meeting, and then incorporate the feedback into the designs. 
                                After a majority of the goals were set for the design, especially the information architecture and the layout, I started to build out the pages on Wordpress. 
                                Since I was using elementor, the process was pretty streamlined and I could eliminate the need for a prototype and instead used the actual build to get more feedback on elements like motion, animation, and general navigational feel. 
                                Now that the majority of the website is built and finalized, we're just waiting on the finalization of the menu and the photoshoot from the cafe owner to publish the website.
                            </p>
                        </div>
                    </div>
                    <div>
