                ...
                <div className="md:flex-grow">
                    <div id="1" className="md:pl-10 min-h-screen xl:min-h-0 xl:pb-20">
                        ...
                        <div className="mt-20 text-slate-600 font-light">
                            ...
                            <p className="pb-3 pt-5">Focusing on accessibility of information, ease of presentation, and incorporation of a more distinct color scheme and modern style, the website came to be what it is currently.</p>
