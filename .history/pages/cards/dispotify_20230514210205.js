                ...
                <div className="md:flex-grow">
                    ...
                    <div id="3" className="md:pl-10 mb-20 pb-10 pt-10">
                        ...
                        <div className="mt-20 text-slate-500 font-light">
                            ...
                            <p>I didn’t focus too much on design for V1 since I spent so much time learning how to set everything up. For V2, I wanted to incorporate some more elements such as:
                    ...
                    <div id="4" className="md:pl-10 min-h-screen pt-10">
                        ...
                        <div className="mt-20 text-slate-500 font-light">
                            ...
                            <p className="mb-10">Accessing a spotify user's information requires setting up authentication. The tutorial I found was really helpful in learning how to set up NextAuth, as well as a refresh token function. Since Spotify's API gives you an access token that expires, setting up an automatic refresh token renewal was key to ensuring that a user's session in the app would be able to persist. </p>
                            <p className="font-semibold text-slate-900 pb-4">State Management</p>
                            <p className="mb-10">The tutorial also showed me how to use recoil for state management, which was really helpful for this project in particular since I didn't need to save too much information and it works well with React. Recoil breaks up state management into "atoms" which I see as mini pockets of states that  </p>
