                ...
                <div className="md:flex-grow">
                    ...
                    <div id="5" className="md:pl-10 pt-10 pb-20">
                        ...
                        <ul className="list-disc text-slate-500 font-light pl-3 pt-10">
                            ...
                            <li>I still had much to reflect on creating an organized structure for myself, and setting better intermittent goals to keep myself focused and directed.</li>
                        </ul>
                    </div>
