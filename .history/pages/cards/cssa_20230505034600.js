                ...
                <div className="flex-grow">
                    ...
                    <div id="4" className="pl-10 pt-10 min-h-screen">
                        ...
                        <div className="my-10 text-slate-500 font-light">
                            ...
                            <p>The main actual improvement I say I made to the website architecture for the CSSA was transferring the file system from Filezilla to Github.</p>
                            <p>Making a new repo was easy since I was just starting a new website from scratch. It was the deploying and hosting side of things that I barely understood and by far the most important part.</p>
                            <p>Now it would be a bit egregious of me to say I did this myself. I barely listened in class when it came to using Git so I was lost - but I knew some people who would’nt be, and that would be the OCF.</p>
