                ...
                <div className="md:flex-grow">
                    ...
                    <div id="3" className="md:pl-10 pt-10 min-h-screen pb-20">
                        ...
                        <div className="mt-10">
                                ...
                                <p className="text-slate-500 font-light">Used a moodboard to give help nail down desired visual deisgn elements using visual cues - asked questions about general aesthetic, layout, colors, etc.</p>
                                <div className="pt-5 pb-10">
