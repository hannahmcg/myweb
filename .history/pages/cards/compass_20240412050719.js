                            ...
                            <div className="mt-10">
                                ...
                                <div className="flex justify-center items-end mt-4">
                                    <div className="md:p-5">
                                        ...
                                        <p className="text-center text-slate-600 font-light text-sm">Case Manager View</p>
                                    </div>
                                    <div className="md:p-5">
                                        <Image src={compasspp} className="object-contain md:mx-auto" width={150} height={150} alt="visual design elements for compass"/>
                                        <p className="text-center text-slate-600 font-light text-sm">Para Educator View</p>
                                    </div>
                                </div>
                            </div>
                            <div className="mt-10">
