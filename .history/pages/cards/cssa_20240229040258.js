          ...
          <main className="px-5 md:px-20 lg:px-40 pb-20 pt-10 bg-gray-50">
              <section className="items-center text-center md:min-h-screen pb-10 md:pb-0">
                <div className="pt-5 pb-10">
                    <Image src={cssacomputerG} priority={true} className="mx-auto" width={700} height={700} alt="example UI of cssa website"/>
                </div>
                ...
                <div className="md:flex-grow">
                    <div id="1" className="md:pl-10 min-h-screen xl:min-h-0 xl:pb-20">
                        ...
                        <div className="mt-20">
                            ...
                            <p className="text-slate-600 font-light">UC Berkeley’s CSSA is the main undergraduate organization for anyone with an interest in Cognitive Science. 
