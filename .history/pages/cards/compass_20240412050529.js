                            ...
                            <div className="mt-10">
                                ...
                                <div className="flex justify-center mt-4">
                                    <div className="md:p-5">
                                        <Image src={compasscm} className="object-contain md:mx-auto" width={300} height={300} alt="visual design elements for compass"/>
                                        <p className="text-center text-slate-600 font-light text-sm">Quick look at the visual design elements.</p>
                                    </div>
                                    <div className="md:p-5">
                                        <Image src={compasspp} className="object-contain md:mx-auto" width={100} height={100} alt="visual design elements for compass"/>
                                        <p className="text-center text-slate-600 font-light text-sm">Quick look at the visual design elements.</p>
                                    </div>
                                </div>
                            </div>
