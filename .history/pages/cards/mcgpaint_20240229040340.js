...
import mcgpaintcomputerG from '../../public/cards/mcgpaint-computerG.png';
...
function Mcgpaint() {
    return (
      <div className="scroll-smooth">
          ...
          <NavMain />
          <main className="px-10 md:px-20 lg:px-40 pb-20 pt-10 bg-gray-50">
              <section className="items-center text-center md:min-h-screen pb-10 md:pb-0">
                <div className="pt-5 pb-10">
                    <Image src={mcgpaintcomputerG} priority={true} className="mx-auto" width={700} height={700} alt="example UI of mcgowan painting website"/>
                </div>
                <div className="px-2 py-4">
                    <h1 className="font-semibold text-xl md:text-4xl text-slate-900">McGowan Painting Commissioned Website Build</h1>
                    <p className="text-slate-500 text-sm md:text-base mt-10">Build a website from scratch for a commission by a painting contractor.</p>
                </div>
              </section>
              ...
              <section className="md:flex">
                ...
                <div className="md:flex-grow">
                    ...
                    <div id="2" className="md:pl-10 pt-10 mb-20">
                    ...
                    <div id="3" className="md:pl-10 pt-10 mb-20">
