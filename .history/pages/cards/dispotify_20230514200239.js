                ...
                <div className="md:flex-grow">
                    ...
                    <div id="1" className="md:pl-10 min-h-screen">
                        ...
                        <div className="mt-20 text-slate-500 font-light">
                            <p className="font-semibold text-slate-900">What is Discover Spotify?</p>
                            <p>Discover Spotify is a personal project which I started with the intentions of developing my skills in working with APIs and state management. Through building and exploring I also ended up learning authentication with NextAuth.</p>
                            <p>I wanted to build something that I could use. I spend hours scouring through random playlists on Spotify so I figured why not make something that could do that for me?</p>
