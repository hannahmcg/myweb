          ...
          <main className="px-5 md:px-20 lg:px-40 pb-20 pt-10">
              <section className="items-center text-center md:min-h-screen pb-10 md:pb-0">
                <div className="pt-5 pb-10">
                    <Image src={compasscomputer} priority={true} className="object-contain mx-auto" width={700} height={700} alt="example UI of compass app"/>
                </div>
                ...
                <div className="md:flex-grow">
                    ...
                    <div>
                        <div id="2" className="md:pl-10 pt-10 pb-20">
                            ...
                            <div className="pt-5 pb-10">
                                <Image src={hbvisualdesign} priority={true} className="object-contain mx-auto" width={700} height={700} alt="Hops & Beans Website Visual Design Elements"/>
                            </div>
                            <div className="mt-10">
