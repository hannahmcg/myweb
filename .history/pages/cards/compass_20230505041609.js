...
function Compass() {
    return (
      <div className="scroll-smooth">
          ...
          <nav className="p-10 max-w-screen-xl flex flex-wrap justify-between mx-auto items-center text-slate-900 hover:text-light-blue-500 active:text-light-blue-800">
