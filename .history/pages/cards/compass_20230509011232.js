          ...
          <main className="px-10 md:px-20 lg:px-40 pb-20 pt-10 w-screen">
              ...
              <section className="md:flex">
                ...
                <div className="md:flex-grow">
                    ...
                    <div id="2" className="md:pl-10 pt-10 min-h-screen">
                        ...
                        <div className="">
                            ...
                            <div className="md:p-5">
                                <Image src={compassds} className="object-contain md:mx-auto" width={400} height={400} alt="visual design elements for compass"/>
                            </div>
                    ...
                    <div id="3" className="md:pl-10 pt-10 pb-20">
