...
function Compass() {
    return (
      <div className="scroll-smooth">
          ...
          <nav className="p-10 max-w-screen-xl flex flex-wrap justify-between mx-auto items-center text-slate-900">
            <Link href="/"><h1 className="text-xl font-pixel">HM:H+M</h1></Link>
            <div className="w-ful md:block md:w-auto">
              <ul className="flex items-center hover:text-light-blue-500 active:text-light-blue-800">
                    ...
                    <div id="1" className="pl-10 h-screen motion-safe:animate-fadeIn">
                        ...
                        <div className="mt-20 text-slate-500 font-light">
                            ...
                            <p>Compass is <span className="text-light-blue-600">a nonprofit and entirely volunteer-led and sustained project</span> 
                                ...
                                application aims to <span className="text-light-blue-600">streamline their current "nondigital" process of data collection</span>
                            ...
                            <p>The team is primarily broken up into two subteams - Engineering and Design, with
                                ...
                                <a className="text-light-blue-600 hover:text-light-blue-300 cursor-pointer underline decoration-dotted underline-offset-3" 
                                href="https://github.com/sfbrigade/compass">here</a>.
                            </p>
                        </div>
                        <div className="mt-20 text-slate-500 font-light">
                            <p className="font-semibold text-slate-900 pb-1">How am I involved?</p>
                            <p>I joined the project as a <span className="text-light-blue-600">full stack engineer</span> with an 
                            added interest in <span className="text-light-blue-600">product design</span> and UI design. 
                            I was looking to broaden my understanding of overall web architecture and knowing the best approaches 
                            and methods to take for a desired product, which I'll get into more detail about below. 
