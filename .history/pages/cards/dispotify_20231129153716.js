          ...
          <main className="px-5 md:px-20 lg:px-40 pb-20">
              <section className="items-center text-center md:min-h-screen pb-10 md:pb-0">
                ...
                <div className="px-2 py-2">
                    ...
                    <p className="text-slate-400 text-sm md:text-base mt-10">Build responsive wep app that utilizies the Spotify API to generate curated playlists and info for a user.</p>
                </div>
              </section>
