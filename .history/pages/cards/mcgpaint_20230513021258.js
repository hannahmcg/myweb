            ...
            <nav className="py-10 max-w-screen-xl flex flex-wrap justify-between mx-auto items-center text-slate-900 dark:text-white">
              ...
              <section className="items-center text-center min-h-screen">
                ...
                <div className="px-2 py-2">
                    <h1 className="font-semibold text-xl md:text-4xl">McGowan Painting Commissioned Website Build</h1>
                ...
                <div className="flex-grow">
                    ...
                    <div id="5" className="md:pl-10 pt-20 pb-20">
                        ...
                        <ul className="list-disc text-slate-500 font-light pl-3">
                            ...
                            <li>I also had to consider pricing elements and determine what my hours were worth, especially for a first time client which was super difficult for me. I just went with what I saw a typical beginner freelance fee was ($15/hr). I was lucky in this case though since my client was pretty much guaranteed.</li>
