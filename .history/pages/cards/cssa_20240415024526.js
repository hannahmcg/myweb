                ...
                <div className="md:flex-grow">
                    <div id="1" className="md:pl-10 min-h-screen xl:min-h-0 xl:pb-20">
                        ...
                        <div className="mt-20">
                            ...
                            UC Berkeley’s Cognitive Science Student Association (CSSA) is the <span className="text-light-blue-600 font-medium">main undergraduate organization for anyone with an interest in Cognitive Science</span>. 
                            It’s widely <span className="text-light-blue-600 font-medium">recognized for its hosting of the annual California Cognitive Science Conference</span> (CCSC). 
                        ...
                        <div className="mt-20 text-slate-600 font-light">
                            ...
                            <p className="pb-3">As the Tech Director of the organization, I decided to take on the challenge of <span className="font-medium text-light-blue-600">changing the website for the first time since its creation over ten years prior.</span>
                            ...
                            <p className="pb-1">My first decision: update the existing website to incorporate the new changes, or just start from scratch?
                                There were <span className="font-semibold text-light-blue-600">two main reasons why I decided to go all new</span>: </p>
                            ...
                            <p className="pb-3 pt-5">Focusing on accessibility of information, ease of presentation, and incorporation of a more distinct color scheme and modern style, the website came to be what it is currently. 
                            Check out the result: <a href="https://cssa.berkeley.edu/" target="_blank" className="underline text-light-blue-600">CSSA Website</a></p>
                        </div>
                    </div>
