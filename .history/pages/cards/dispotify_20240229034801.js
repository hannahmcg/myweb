          ...
          <main className="px-5 md:px-20 lg:px-40 pb-20 pt-10 bg-gray-50">
              <section className="items-center text-center md:min-h-screen pb-10 md:pb-0">
                <div className="pt-5 pb-10">
                    <Image src={dispotifycomputer} priority={true} className="mx-auto" width={700} height={700} alt="example UI of discoverspotify app"/>
                </div>
              ...
              <iframe style="border: 1px solid rgba(0, 0, 0, 0.1);" width="800" height="450" src="https://www.figma.com/embed?embed_host=share&url=https%3A%2F%2Fwww.figma.com%2Fproto%2FxvSpysW4ZzDaQhRuGvBYFr%2Fportfo-projs%3Ftype%3Ddesign%26node-id%3D358-103%26t%3DoV140gHK4XuYhSqT-1%26scaling%3Dscale-down%26page-id%3D1%253A2%26mode%3Ddesign" allowfullscreen></iframe>
              <section className="md:flex">
                ...
                <div className="md:flex-grow">
                    ...
                    <div id="1" className="md:pl-10 mb-20">
                        ...
                        <h2 className="italic pt-10 mt-10 text-slate-600">Note: This website is currently in V2. I'll walk through both V1 and V2 in this case study!</h2>
