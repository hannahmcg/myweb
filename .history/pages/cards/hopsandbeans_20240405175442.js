                        ...
                        <div id="2" className="md:pl-10 pt-10 pb-20">
                            ...
                            <div className="mt-10">
                                ...
                                <ul className="list-disc pl-10 mt-5 text-slate-500 font-light">
                                    <li><span className="font-semibold">Spacing:</span> Intentional use of white space to visually aid in the hierarchy and categorization of elements.</li>
                                    <li><span className="font-semibold">Motion:</span> Limited and simple use of motion in certain elements.</li>
                                    <li><span className="font-semibold">Color:</span> AAA contrasting color usage.</li>
                                    <li><span className="font-semibold">Concise:</span> Information is concise and easily navigable.</li>
                                </ul>
                            </div>
                            <div className="mt-10">
