          ...
          <main className="px-5 md:px-20 lg:px-40 pb-20 pt-10 w-screen">
              ...
              <section className="flex">
                ...
                <div className="md:flex-grow">
                    <div id="1" className="md:pl-10 min-h-screen motion-safe:animate-fadeIn">
                        ...
                        <div className="mt-20 text-slate-500 font-light">
                            ...
                            <p className="pb-3">My senior year I got elected as the sole Tech Director, and decided to take on the challenge of <span className="font-semibold text-light-blue-700 p-1 rounded-sm">changing the website for the first time since it’s creation over ten years prior.</span>
                            ...
                            <p className="pb-3">My first decision was whether or not to update the existing website to incorporate the new changes or to just start from scratch. 
                                There were <span className="font-semibold text-light-blue-700 p-1 rounded-sm">two main reasons why I decided to go all new</span>: there were too many files to even try deleting, and I wanted to adapt the file system to use Github over Filezilla to ensure a more seamless transitioning phase for future Tech Directors. </p>
