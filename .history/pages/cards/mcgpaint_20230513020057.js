                ...
                <div className="flex-grow">
                    ...
                    <div id="5" className="md:pl-10 pt-20 pb-20">
                        ...
                        <ul className="list-disc text-slate-500 font-light pl-3">
                            ...
                            <li>Consequently, I also realized how much work goes into discussing things with a client and understanding their goals and how I can go about realizing them in a way that I find optimal.</li>
                        </ul>
