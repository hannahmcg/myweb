                ...
                <div className="md:flex-grow">
                    ...
                    <div id="4" className="md:pl-10 min-h-screen pt-10">
                        ...
                        <div className="mt-20 text-slate-500 font-light">
                            ...
                            <p className="mb-10">This app was pretty much built around my desire to play around with the Spotify API. I love listening to music, and I'm always looking for new songs. The API's "get recommendations" feature was a great way for me to build something that looks for songs for me. I figured I could first get a user's listening habits (top artists and tracks), save the state of that info and then feed it as the seed entity to the recommendations function. </p>
