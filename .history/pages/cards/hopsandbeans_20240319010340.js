                ...
                <div className="md:flex-grow">
                    ...
                    <div id="1" className="md:pl-10 min-h-screen xl:min-h-0 xl:pb-20">
                        <div className="grid grid-cols-2 gap-4 md:grid-cols-4 text-sm">
                            ...
                            <div className="text-slate-500 font-light">
                                <p className="font-semibold text-slate-900">Clinet</p>
                                <p>Hops & Beans Cafe</p>
                            </div>
                            <div className="text-slate-500 font-light">
                        ...
                        <div className="mt-20 text-slate-500 font-light">
                            <p className="font-semibold text-slate-900 pb-1">Overivew</p>
                            <p>Hops & Beans Cafe is a locally-owned cafe in Fremont, CA. It's located at the oldest commercial building in the city, and serves a great selection of craft coffee, beers, and bites. As a former barista, I reached out to the owner about drafting up a new website for the cafe. </p>
                            <br></br>
                            <p>something pt 2
                            </p>
                        </div>
