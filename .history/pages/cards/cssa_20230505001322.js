                ...
                <div className="flex-grow">
                    <div className="pl-10 h-screen motion-safe:animate-fadeIn">
                        ...
                        <div className="mt-20 text-slate-500 font-light">
                            ...
                            <p className="pb-3">My <span className="bg-light-blue-100 p-1">first decision</span> was whether or not to update the existing website to incorporate the new changes or to just start from scratch. 
