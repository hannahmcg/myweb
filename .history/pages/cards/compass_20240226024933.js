                ...
                <div className="md:flex-grow">
                    ...
                    <div>
                        <div id="2" className="md:pl-10 pt-10 pb-20">
                            ...
                            <div className="mt-10">
                                <p className="font-semibold text-slate-800 pb-1">Overview</p>
                                <p className="text-slate-600 font-light">Since this is a volunteer-led project, every member of the team has been intimately involved in each step of the design process.</p>
                            </div>
                            <div className="mt-10">
                                <p className="font-semibold text-slate-800 pb-1">The Users & The Problem</p>
                                <p className="text-slate-600 font-light">Compass was created with the intention of aiding the work of staff that work with students with disabilities in the SFUSD. This staff is primarily composed of case managers and paraeducators. Due to lack of funding, there is no digital presence or application that is geared towards managing the process of their IEP goal creation and task delegation. Much of their work is done on paper, which also doesn’t allow for much room or ability to analyze and visualize a student’s progress.</p>
                            </div>
                            <div className="mt-10">
                    ...
                    <div id="5" className="md:pl-10 pt-10 pb-20">
                        ...
                        <p className="font-semibold mt-10">I've worked with a lot of new tools and concepts. Here are some of the main things so far:</p>
