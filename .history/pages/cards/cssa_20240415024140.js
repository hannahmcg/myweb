                ...
                <div className="md:flex-grow">
                    <div id="1" className="md:pl-10 min-h-screen xl:min-h-0 xl:pb-20">
                        ...
                        <div className="mt-20 text-slate-600 font-light">
                            ...
                            <p className="pb-3">As the Tech Director of the organization, I decided to take on the challenge of <span className="font-semibold text-light-blue-700">changing the website for the first time since its creation over ten years prior.</span>
