              ...
              <section className="md:flex">
                ...
                <div className="md:flex-grow">
                    ...
                    <div id="1" className="md:pl-10 min-h-screen xl:min-h-0 xl:pb-20">
                        ...
                        <div className="mt-20 text-slate-500 font-light">
                            <p className="font-semibold text-slate-900 pb-1">How it went?</p>
                            <p>I set up a meeting to establish initial goals and thoughts about new website. Did competitive analysis on a variety of websites to narrow down the approach. 
                                ...
                                From there, the design and development process was very iterative. I would draft up a couple ideas and examples in figma, we would discuss them in the meeting, and then incorporate the feedback into the designs. 
