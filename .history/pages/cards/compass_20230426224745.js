      ...
      <div>
          ...
          <main className="px-20 pb-20 pt-10 w-screen">
              <section className="items-center text-center">
                <div className="">
                    <Image src={compasscomputer} className="object-contain mx-auto" width={700} height={700} alt="example UI of compass app"/>
                </div>
                <div className="px-2 py-4">
                    <h1 className="font-semibold text-2xl">Project Compass with Code for San Francisco</h1>
                </div>
              </section>
              <section></section>
          </main>
