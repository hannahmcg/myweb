          ...
          <main className="px-20 pb-20 pt-10 w-screen">
              <section className="items-center text-center">
                ...
                <div className="px-2 py-4">
                    ...
                    <p className="text-slate-400">An overview of my involvement with Compass - a nonprofit and volunteer driven project founded within Code for San Francisco.</p>
                </div>
              </section>
              <section></section>
          </main>
