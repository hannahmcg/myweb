                ...
                <div className="flex-grow">
                    <div className="pl-10 h-screen motion-safe:animate-fadeIn">
                        ...
                        <div className="mt-20 text-slate-500 font-light">
                            ...
                            <p className="pb-2">I joined the CSSA my second year of university. I got elected as the co-Tech Director my third year, during which time 
                            ...
                            <p className="pb-2">My senior year I got elected as the sole Tech Director, and decided to take on the challenge of changing the website for the first time since it’s creation over ten years prior. 
                                It was my first attempt at many things - design, planning, building. </p>
                            <p className="pb-2">My first decision was whether or not to update the existing website to incorporate the new changes or to just start from scratch. 
                            ...
                            <p className="pb-2">The former website was incredibly informative, but to a fault - there was more than anyone would have the time to read, and much of the information was almost impossible to find. 
