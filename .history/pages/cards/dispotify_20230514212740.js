                ...
                <div className="md:flex-grow">
                    ...
                    <div id="1" className="md:pl-10 min-h-screen">
                        ...
                        <div className="mt-20 text-slate-500 font-light">
                            ...
                            <p className="pb-3">I wanted to build something that I could use. I spend hours scouring through random playlists on Spotify looking for new songs so I figured, why not make something that could do that for me?</p>
