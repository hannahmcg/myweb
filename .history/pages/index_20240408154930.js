    ...
    <div className={darkMode ? "dark" : ""}>
      ...
      <NavMain />
        <section className="px-5 md:px-8 lg:px-10 pt-20 md:pt-5">
          ...
          {/* bg-blue-gray-100 */}
          <div className="md:pt-20 min-h-screen bg-feet-bg bg-contain bg-no-repeat bg-center md:bg-right-bottom bg-blend-color-burn my-4 mt-4 mb-20">
            <h1 className="text-6xl md:text-9xl pl-4 text-slate-900 ">HANNAH MCG</h1>
