...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      ...
      <nav className="py-10 px-10 md:px-20 lg:px-40 max-w-screen-xl flex flex-wrap justify-between mx-auto items-center text-slate-900">
      ...
      <main className= "min-h-screen px-10 md:px-20 lg:px-40">
        <section className="">
