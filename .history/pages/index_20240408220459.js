      ...
      <NavMain />
        <section className="px-5 md:px-8 lg:px-10 pt-20 md:pt-5">
          ...
          <div className="md:pt-20 min-h-screen bg-feet-bg bg-contain bg-no-repeat bg-center md:bg-right-bottom mt-4">
            <h1 className="text-6xl md:text-9xl pl-4 text-slate-50 mix-blend-color-burn">HANNAH MCG</h1>
          ...
          <div className="">
              <div className="flex items-center justify-center bg-index-bg-m lg:bg-index-bg bg-contain bg-no-repeat bg-center">
