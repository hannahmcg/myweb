              ...
              <section>
                <div className="flex">
                    <div className="outline-slate-500 outline rounded-md mx-auto grid grid-cols-3 h-40 w-full hover:bg-light-blue-50">
                        <div className="">
                            <p className=" text-xl px-2 py-4">COMPASS</p>
                        </div>
                        <div className="">
                            <p className="outline-slate-500 outline rounded-md px-1 w-min mt-2">full stack development</p>
                            <p className="outline-slate-500 outline rounded-md px-1 w-min mt-2">ui/ux design</p>
                        </div>
                        <div className="flex">
