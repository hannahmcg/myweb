    ...
    <div className={darkMode ? "dark" : ""}>
      ...
      <main className= "px-10 md:px-15 lg:px-20">
        ...
        <section>
          ...
          <Image src={berksticker} className="w-full h-auto shadow-lg hover:shadow-2xl hover:shadow-light-blue-100 active:border-blue-200 active:border-2" sizes="100vw" width="0" height="0" alt="berkeley sticker"/>
