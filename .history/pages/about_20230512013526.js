            ...
            <div className="lg:flex lg:items-center justify-center">
                <div className="m-5 pl-5">
                    <ul className="list-disc leading-8 marker:text-light-blue-700 text-slate-700 font-light pl-5">
                      ...
                      <li><span className="text-light-blue-700 font-semibold">Education: </span>Graduated from UC Berkeley in 2022 with degrees in Cognitive Science and Economics</li>
