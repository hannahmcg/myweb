...
import berksticker from '../public/berk-sticker.png';
import berkstickersvg from '../public/berk-sticker.svg';
import SvgComponent from '../components/berksticker.js';
      ...
      <main className= "px-10 md:px-15 lg:px-20">
        ...
        <section className="mb-10">
          <div className="flex justify-center">
            <Image src={stickers1} className="hidden lg:block" width={1100} height={1100} priority={true} alt="fruit stickers with my info in them"/>
        ...
        <section className="bg-black">
          ...
          {/*<Image src={berksticker} className="rounded-full w-full h-auto bg-transparent shadow-lg hover:shadow-2xl hover:shadow-light-blue-100 active:border-blue-200 active:border-2" sizes="100vw" width="0" height="0" alt="berkeley sticker"/>*/}
          {/*<svg xmlns={berkstickersvg}></svg> */}
          <Image src={berkstickersvg} className="hover:shadow-2xl hover:shadow-light-blue-100" width={500} height={500} alt="berk sticker svg"/>
          <SvgComponent className="hover:shadow-2xl hover:shadow-light-blue-100"/>
