    ...
    <div className={darkMode ? "dark" : ""}>
      ...
      <NavMain />
        <section className="px-5 md:px-8 lg:px-10 pt-20 md:pt-5">
          <div className="pt-20 min-h-screen bg-blue-gray-100">

            <h1 className="text-9xl">HANNAH MCG</h1>
            <div>
              <h3>PORTFOLIO</h3>
          ...
          <div className="min-h-screen">
            <div className="justify-center"> 
              <h3 className="font-bold justify-center text-center pt-50">HANNAH MCG</h3>
