      ...
      <div>
          ...
          <main className="px-10 md:px-20 lg:px-40 pb-20 pt-20 bg-gray-50">
            ...
            <div className="text-center pb-10">
              ...
              <section>
                <div className="flex">
                    <div className="outline-slate-500 outline rounded-md mx-auto grid grid-cols-3 h-auto w-full hover:bg-light-blue-50 py-6 px-4">
                        <div className="">
                            <p className="text-2xl pb-4">COMPASS</p>
                            <p className="pr-6 text-sm">Open-source application built for case managers and paraeducators of the SFUSD. Digitizing their workflow processes, especially in data collection and analysis.</p>
                        </div>
