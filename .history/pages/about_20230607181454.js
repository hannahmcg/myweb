        ...
        <div className="pb-20 pt-10">
          <div className="flex justify-center space-x-10 pb-10">
            ...
            <div className="md:w-1/2 text-slate-500">
              <p>I’m <span className="text-light-blue-600">interdisciplinary</span> - my interests, passsions, career paths; everything seems to revolve around my pension for trying new things and making interesting connections.</p>
