        ...
        <div className="pb-20 pt-10">
          <div className="flex justify-center space-x-10 pb-10">
            ...
            <div className="md:w-1/2 text-slate-500 space-y-3 md:space-y-1">
              ...
              <p>I’m <span className="text-light-blue-600">perceptive</span> - I have an acute awareness of how human behavior can translate into any decision.</p>
              <p>I’m <span className="text-light-blue-600">creative and curious</span> - I'm always exploring new mediums or ideas of any kind and they're all equally motivating.</p>
              <p>I'm <span className="text-light-blue-600">driven</span> - with a set goal in mind, I'll find any way to achieve it.</p>
            </div>
            </div>
          </div>
