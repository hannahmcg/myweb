              ...
              <section>
                <div className="lg:flex lg:justify-center gap-10 items-center">
                    <Link href="cards/compass" className="lg:w-1/3">
                        <div className="shadow-lg hover:shadow-2xl hover:shadow-transparent hover:shadow-light-blue-100 overflow-hidden dark:shadow-blue-500 rounded-xl my-10 active:border-blue-200 active:border-2">
                    ...
                    <Link href="cards/cssa" className="lg:w-1/3">
                        <div className="shadow-lg hover:shadow-2xl overflow-hidden dark:shadow-blue-500 rounded-xl my-10 active:border-blue-200 active:border-2">
                ...
                <Link href="cards/mcgpaint" className="lg:w-1/3">
                    <div className="shadow-lg hover:shadow-xl hover:shadow-light-blue-100 overflow-hidden dark:shadow-blue-500 rounded-xl my-10 active:border-blue-200 active:border-2">
                        <div className="relative w-full h-80">
                ...
                <Link href="cards/dispotify" className="lg:w-1/3">
                    <div className="shadow-lg hover:shadow-2xl active:border-blue-200 active:border-2 overflow-hidden dark:shadow-blue-500 rounded-xl my-10">
                        <div className="relative h-80 w-full md:h-90">
