                ...
                <div className="flex">
                    <div className="outline-slate-500 outline rounded-md mx-auto grid grid-cols-3 h-auto w-full hover:bg-light-blue-50 py-6 px-6">
                        <div className="">
                            ...
                            <p className="pr-10 text-sm">Open-source application built for case managers and paraeducators of the SFUSD. Digitizing their workflow processes, especially in data collection and analysis.</p>
                        </div>
