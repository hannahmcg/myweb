    ...
    <div>
        ...
        <div className="pb-20 pt-10">
          <div className="flex justify-center space-x-10 pb-10">
            ...
            <div className="md:w-1/2 w-[200px] mx-auto pb-5 md:pb-0">
            ...
            <div className="md:w-1/2 text-slate-500">
              <p>I’m <span className="text-light-blue-600">interdisciplinary</span> - my interests, passsions, career paths; everything seems to revolve around my pension for not only wanting to try new things, but for making novel connections with the things I know.</p>
              <p>I’m somewhat of a <span className="text-light-blue-600">time cruncher</span> - a fancier way of saying I sometimes procrastinate, which is to say that I'm always looking for efficient solutions and I have an acute awareness of how human behavior can translate into any decision.</p>
              <p>I’m <span className="text-light-blue-600">creative and curious</span> - I'm always wanting to explore new mediums to the effect of sometimes finding it hard to get things done; with a vision and plan, however, then end result is more than satisfying.</p>
            </div>
            </div>
          </div>
