          ...
          <p className="text-lg text-slate-400">who am i? where do i come from? where do i go?</p>
            ...
            <div className="lg:flex lg:items-center justify-center">
                <div className="px-5">
                    ...
                    <p className="leading-10">Hi I'm hannah. I like things and things and I'm interested in things and I like a lot of things.</p>
                    <p className="leading-10">This where i went to school and what I studied. This is cool stuff I do and like to do as hobbies or interests.</p>
                </div>
                <div className="p-10">
