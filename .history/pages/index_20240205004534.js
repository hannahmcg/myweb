...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      ...
      <main className= "px-5 md:px-8 lg:px-10 min-h-screen">
      <NavMain />
        ...
        <section className="">
          <div className="flex justify-center">
            ...
            <Image src={stickerstext} className="hidden lg:block max-w-screen-2xl h-auto" sizes="100vw" width="0" height="0" priority={true} alt="fruit stickers with my info in them"/>
