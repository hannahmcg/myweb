    ...
    <div className={darkMode ? "dark" : ""}>
      ...
      <main className= "px-10 md:px-20 lg:px-40">
        ...
        <section className="mb-10">
            <Image src={stickers0} className="hidden lg:block h-auto max-w-full object-contain" width={1160} height={870} alt="fruit stickers with my info in them"/>
            <Image src={stickers00} className="lg:hidden h-auto max-w-full object-contain" width={870} height={1160} alt="fruit stickers with my info in them"/>
        </section>
