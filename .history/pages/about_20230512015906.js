  ...
  return (
    <div>
        ...
        <main className="px-10 md:px-20 lg:px-40 pt-5">
            ...
            <div className="pb-10 lg:flex lg:items-center lg:justify-center lg:space-x-5">
                <div className="w-1/2 px-5">
                    <ul className="list-disc leading-8 marker:text-light-blue-600 text-slate-700 font-light pl-5">
                      <li><span className="text-light-blue-600 font-semibold">Intro: </span>Hi, I'm Hannah! I'm looking for a job and I have too many hobbies</li>
                      ...
                      <li><span className="text-light-blue-700 font-semibold">Music: </span>I really like music. I'm always finding new genres, languages, and vibes to obssess over. I’ve dabbled around with max 8, original comps on the piano, garageband for years and have recently graduated up to FLStudio (free version :D)  
                      <ul className="list-disc leading-6 marker:text-light-blue-600 text-slate-700 font-light pl-5 text-sm">
                        <li>I just recently grag</li>
                      </ul>
                      </li>
