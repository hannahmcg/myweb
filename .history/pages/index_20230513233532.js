    ...
    <div className={darkMode ? "dark" : ""}>
      ...
      <main className= "px-10 md:px-20 lg:px-40">
        ...
        <section className="mb-10">
            <Image src={stickers0} className="overflow-hidden object-cover h-auto max-w-full lg:object-contain" width={1160} height={870} alt="fruit stickers with my info in them"/>
        </section>
