...
export default function NavMain() {
  ...
  return (
    <Navbar fullWidth="true" className="mx-auto max-w-screen-xl px-4 py-2 lg:px-8 lg:py-4 bg-transparent shadow-none">
      <div className="container flex items-center justify-between mx-auto xl:mx-10 text-slate-900">
        <Typography
          as="a"
          href="/"
          variant="h5"
          className="mr-4 cursor-pointer py-1.5 font-pixel hover:text-light-blue-500 active:text-light-blue-800"
        >
          HM:H+M
        </Typography>
