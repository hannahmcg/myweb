...
export default function NavMain() {
  ...
  return (
    <Navbar className="mx-auto max-w-screen-xl px-4 py-2 lg:px-8 lg:py-4 xl:mx-10 bg-transparent shadow-none">
      <div className="container flex items-center justify-between mx-auto text-slate-900">
        <Typography
          as="a"
          href="/"
          variant="h5"
