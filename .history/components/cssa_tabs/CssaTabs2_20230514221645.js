...
export default function CssaTabs2() {
  const data2 = [
    ...
    },
    {
      ...
      items: [
        {
          item: "Started just building it early on in HTML, CSS, and vanilla Javascript. I wanted to get the structure of the site set even in the intial design phases to set the pace early on.",
          val: "i1",
        },
        {
