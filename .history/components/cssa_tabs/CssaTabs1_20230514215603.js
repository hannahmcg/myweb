import {
  ...
  export default function CssaTabs1() {
    const data = [
      ...
      },
      {
        ...
        questions: [
          ...
          {
            question: "When should be website be published by? Are there going to be more edits after publishing?",
            val: "q3",
          },
        ],
      },
    ...
    return (
      <div>
        <Tabs value="content" id="custom-animation" className="max-w-[40rem] h-[20rem]">
          <TabsHeader 
