  ...
  const data2 = [
    ...
    },
    {
      ...
      items: [
        ...
        {
          item: "The process was pretty much a cycle. Discuss content and points, play around with designs on Figma, implement certain elements into the build, show the build, and discuss.",
          val: "i4",
        },
      ],
    },
