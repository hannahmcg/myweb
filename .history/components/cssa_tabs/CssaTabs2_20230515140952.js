...
export default function CssaTabs2() {
  const data2 = [
    ...
    },
    {
      ...
      items: [
        ...
        {
          item: "The process was pretty much a cycle. Discuss content and points, play around with designs on Figma, implement certain elements into the build, show the build and discuss, etc.",
          val: "i4",
        },
      ],
    },
  ...
  return (
    <div>
      <Tabs value="content2" id="custom-animation2" className="max-w-[40rem] h-[25rem]">
        <TabsHeader 
