...
export default function CssaTabs2() {
  const data2 = [
    ...
    },
    {
      ...
      items: [
        ...
        {
          item: "Held meetings with the teams in between designing to discuss styling and decide on the direction of the CCSC page. Ended on keeping the CCSC page as a tab on the website, but giving it a different theme to contrast its purpose.",
          val: "i4",
        },
      ],
    },
  ...
  return (
    <div>
      <Tabs value="content2" id="custom-animation2" className="max-w-[40rem] h-[28rem]">
        <TabsHeader 
