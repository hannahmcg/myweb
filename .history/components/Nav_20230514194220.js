...
export default function NavMain() {
  ...
  return (
    <Navbar className="max-w-screen-xl px-6 lg:px-3 py-5 bg-transparent shadow-none">
      <div className="flex items-center justify-between text-center text-slate-900">
        <Typography
          as="a"
          href="/"
          variant="h5"
