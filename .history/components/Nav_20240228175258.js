...
export default function NavMain() {
  ...
  return (
    <Navbar fullWidth={true} className="bg-transparent shadow-none">
      ...
      <div className="flex fixed w-screen">
        <div class="flex-1 flex justify-center mr-auto">
            <Typography
              ...
              href="/"
              variant="h3"
              className="3xl:text-4xl mr-4 cursor-pointer py-1.5 text-black hover:text-light-blue-500 active:text-light-blue-800"
            >
              H+M
            </Typography>
          </div>
          ...
          <div class="flex-1 flex justify-center ml-auto">
              <a class="mx-2 text-black">CONTACT</a>  
          </div>
