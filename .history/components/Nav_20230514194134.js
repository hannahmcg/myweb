...
export default function NavMain() {
  ...
  return (
    <Navbar className="mx-5 max-w-screen-xl px-6 lg:px-3 py-5 bg-transparent shadow-none">
      <div className="flex items-center justify-between mx-auto text-slate-900">
        <Typography
          as="a"
          href="/"
          variant="h5"
          className="mr-4 cursor-pointer py-1.5 font-pixel"
        >
          HM:H+M
        </Typography>
