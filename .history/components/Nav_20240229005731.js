...
function NavList() {
  return (
    <ul className="my-3 flex flex-col items-end justify-center gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      >
        <a href="/work" className={`flex items-center hover:text-light-blue-500 active:text-light-blue-800 transition-colors ${router.pathname == "/work" ? "text-indigo-600" : "text-brand-darkblue"}`}>
          WORK
        </a>
      </Typography>
      <Typography
