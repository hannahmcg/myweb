  ...
  return (
    <ul className="my-3 flex flex-col items-end justify-center gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      <Typography
        as="li"
        variant="h6"
        className="text-lg xl:text-2xl p-1 font-semibold text-slate-900"
      >
      ...
      <Typography
        as="li"
        variant="h6"
        className="text-lg p-1 font-semibold text-slate-900"
      >
      ...
      <Typography
        as="li"
        variant="h6"
        className="text-lg 2xl:text-xl p-1 font-semibold text-slate-900"
      >
    ...
    <Navbar fullWidth={true} className="mx-auto px-12 py-3 bg-transparent shadow-none">
      <div className="flex items-center justify-between text-slate-900">
        <Typography
          ...
          href="/"
          variant="h3"
          className="text-xl xl:text-4xl mr-4 cursor-pointer py-1.5 hover:text-light-blue-500 active:text-light-blue-800"
        >
          H+M
        </Typography>
