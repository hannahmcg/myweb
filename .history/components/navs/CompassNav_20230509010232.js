...
function CompassNav() {
    ...
    return (
        <nav className="sticky bg-white md:bg-transparent pr-2 md:pr-12 h-10 top-0 md:top-10 text-center">
            <ul className="flex space-x-4 md:flex-col pt-2 md:pt-0 md:space-x-0 list-none bg-white md:bg-transparent text-slate-900 md:space-y-2">
