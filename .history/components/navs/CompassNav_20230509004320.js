...
function CompassNav() {
    ...
    return (
        <nav className="sticky bg-white md:bg-transparent pr-2 md:pr-12 h-10 top-10">
            <ul className="flex list-none bg-white md:bg-transparent text-slate-900 space-y-2">
