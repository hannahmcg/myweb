...
function WorkNav() {
    ...
    return (
        <div className="">
            <div className="pr-2 md:pr-12 h-10">
                <ul className="sticky top-10" data-hs-scrollspy="#scrollspy-2" data-hs-scrollspy-scrollable-parent="#scrollspy-scrollable-parent-2">
